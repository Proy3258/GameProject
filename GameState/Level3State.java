...
public class Level3State extends GameState {
    ...
    private void populateEnemies() {
        ...
        Gazer g1 = new Gazer(tileMap);
        g1.setPosition(200, 200);
        enemies.add(g1);
        Gazer g2 = new Gazer(tileMap);
        g2.setPosition(700, 150);
        enemies.add(g2);
        Gazer g3 = new Gazer(tileMap);
        g3.setPosition(1200, 80);
        enemies.add(g3);
        Gazer g4 = new Gazer(tileMap);
        g4.setPosition(1500, 200);
        enemies.add(g4);
        Gazer g5 = new Gazer(tileMap);
        g5.setPosition(2300, 200);
        enemies.add(g5);
